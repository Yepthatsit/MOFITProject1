...
namespace Project1.Solutions
{
    class Exercise1
    {
        ...
        public async Task CalculateExplicitEulerSolution()
        {
            ...
            plot.XLabel("Time (s)");
            plot.YLabel("Value");
            var scatter1 = plot.Add.ScatterLine(TimePoints, XValues);
            scatter1.LegendText = "X";
            var scatter2 = plot.Add.ScatterLine(TimePoints, VelocityValues);
            scatter2.LegendText = "V";
            plot.SaveJpeg("Diagrams/explicit_euler.jpg", 500,500);
            plot = new();
            plot.Add.ScatterLine(XValues, VelocityValues);
            plot.XLabel("X");
            plot.YLabel("V");
